...
void FilterComponent::paint (juce::Graphics& g)
{
    ...
    lopLabel.setBounds(sliderStartX, titleLabel.getBottom() - 1.6 * padding, 2 * sliderLabelWidth, sliderLabelHeight);
    lopToggle.setBounds(lopLabel.getRight(), titleLabel.getBottom() - 1.6 * padding, sliderLabelWidth, sliderLabelHeight);
    lopToggleLabel.setBounds(lopToggle.getRight() - padding, titleLabel.getBottom() - 1.6 * padding, sliderLabelWidth + padding, sliderLabelHeight);

    int lopStartY = lopLabel.getBottom() - 3.0 * padding;
